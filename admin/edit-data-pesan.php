<?php 
  ...
  // Data Pesan
  $sql_pesan = mysqli_query($koneksi,"SELECT * FROM tb_pesan WHERE id='$id'");
  $data_pesan = mysqli_fetch_array($sql_pesan);
?>
<!DOCTYPE html>
...
<head>
  ...
  <title>
   Kirim Pesan Pasien - Admin Control
  </title>
  <!--     Fonts and icons     -->
    ...
    <div class="collapse navbar-collapse " id="sidenav-collapse-main">
      <section class="navbar-custom-item">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link justify-content-center" href="data-pasien.html">
              <span class="text-item-custom">Data Pasien</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link active justify-content-center" href="data-pesan.html">
  ...
  <main class="main-content position-relative border-radius-lg ">
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur" data-scroll="false">
      <div class="container-fluid py-1 px-3">
          <p class="font-weight-bolder text-blue page-title">Kirim Pesan Pasien</p>
            ...
            <div class="card mb-4 p-4">
              <div class="card-body px-0 pt-0 pb-2">
                <div class="table-responsive p-0 ">
                  <form action="./proses/proses-edit-pesan.php" method="post">
                    <input type="text" name="id" value="<?= $data_pesan['id'] ?>" hidden>
                    <h4 class="nama-head text-blue ms-0">Pemeriksaan</h4>
                    <input type="text" class="form-control mb-3" name="pemeriksaan" value="<?= $data_pesan['pemeriksaan'] ?>">
                    <h4 class="nama-head text-blue ms-0">Isi Pesan</h4>
                    <textarea class="form-control" style="resize: none;" id="exampleFormControlTextarea1" rows="8" name="pesan" required><?= $data_pesan['pesan'] ?></textarea>
                    <div class="btn-form-container">
                      <button type="submit" class="btn-send-pesan" name="">SIMPAN<i class="fa fa-send"></i></button>
                    </div>
                  </form>
                </div>
              </div>
