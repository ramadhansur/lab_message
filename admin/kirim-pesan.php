            ...
            <div class="card mb-4 p-4">
              <div class="card-body px-0 pt-0 pb-2">
                <div class="table-responsive p-0 ">
                  <form action="./proses/proses-tambah-pesan.php" method="post">
                    <h4 class="nama-head text-blue ms-0">Pemeriksaan</h4>
                    <input type="text" class="form-control mb-3" name="pemeriksaan">
                    <h4 class="nama-head text-blue ms-0">Isi Pesan</h4>
                    <textarea class="form-control" style="resize: none;" id="exampleFormControlTextarea1" rows="8" name="pesan" required></textarea>
                    <div class="btn-form-container">
                      <button type="submit" class="btn-send-pesan" name="">Kirim<i class="fa fa-send"></i></button>
                    </div>
                  </form>
                </div>
              </div>
