...
$pesan = mysqli_query($koneksi, "SELECT * FROM tb_pasien WHERE nama = '$nama' AND status = 'BELUM'");
$kirim = array();
...
foreach($kirim as $data1){
    ...
    $link_password = "\n \n"."Username = ".$data_akun['username']."\n"."Password = http://localhost:8888/arter/confirm-login.php?user=".$data_akun['username']."&nohp=".$data_akun['no_hp'];
